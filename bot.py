...
mail = input("Enter your LinkedIn Email: ")
key = input("Enter your LinkedIn Password: ")
search_param = input("Enter search phrase to find users: ")
message = input("Enter message text (maximum 300 chars): ")
pages_upto = input("Enter maximum pages number in result: ")
totalCount = input("Enter maximum of sending requests: ")
...
for page in range(1, int(pages_upto)):
